...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			currentBillTotal = 0.0; // initializing bill amount to zero
		...
		tip10EditText = (EditText) findViewById(R.id.tip10Editbox);
		total10EditText = (EditText) findViewById(R.id.total10Editbox);
		tip15EditText = (EditText) findViewById(R.id.tip15Editbox);
		total15EditText = (EditText) findViewById(R.id.total15Editbox);

		tip20EditText = (EditText) findViewById(R.id.tip20Editbox);
		total20EditText = (EditText) findViewById(R.id.total20Editbox);
